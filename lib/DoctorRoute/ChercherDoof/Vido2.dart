...
class Vido2 extends StatefulWidget {
  @override
  _Vido2State createState() => _Vido2State();
}

class _Vido2State extends State<Vido2> {
  ...
  _recuperarDadosUsuario() async {
    ...
    _controllerDes.text = dados!["especializacao"];
          ...
          child: SingleChildScrollView(
            child: Column(
              children: <Widget>[
                ...
                Padding(
                  padding: EdgeInsets.only(bottom: 8, top: 8),
                  child: Text("Especialização:", style: TextStyle(fontWeight: FontWeight.bold),),
                ),
                Padding(
                  padding: EdgeInsets.only(bottom: 8),
                  child: TextField(
