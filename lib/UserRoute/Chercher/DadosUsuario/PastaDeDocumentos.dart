...
String _valor;
PastaDoc(this._valor);

  @override
  _PastaDocState createState() => _PastaDocState();
}

class _PastaDocState extends State<PastaDoc> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text(widget._valor),),
      body: Container(
        child: Column(
